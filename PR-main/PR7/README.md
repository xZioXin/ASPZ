...
Ця програма за допомогою popen() виконує команду rwho | more, зчитуючи та виводячи її результат.
...
Ця програма імітує утиліту more. Вона приймає імена файлів як аргументи командного рядка і виводить їхній вміст на екран.
...
Програма знаходить усі підкаталоги в поточній директорії та виводить їхні імена в алфавітному порядку.
...
Ця програма сканує поточний каталог, знаходить усі файли з розширенням .c і виводить їхні імена.
